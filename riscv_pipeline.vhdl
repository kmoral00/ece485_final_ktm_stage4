...
begin
    ...
    opcode <= instr(6 downto 0); --changed from if_id_instr
...
--    if_id_jump    <= jump;
    ...
    alu_control_inst: alu_control
            port map (
                funct3 => instr(14 downto 12), --what signals??
                funct7 => instr(31 downto 25), --what signals??
                alu_op => alu_op
            );
...
------------------------------------------------------------------------------------------
    ...
    -- MUX to write back to register file --THE SAME
